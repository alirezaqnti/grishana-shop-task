...
WORK_DIR = os.environ.get(
    "DJANGO_WORKDIR", os.path.abspath(os.path.join(PROJECT_ROOT, "workdir"))
)
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "3FDI3vKb2aR4r5Tj12JZ0ehSTOg3MQTVS2pKSvk7BqUPeQNXviZY1qkQAaQ0gGDW",
)
...
ELASTICSEARCH_DSL = {
    "default": {"hosts": "{}:9200".format(ELASTICSEARCH_HOST)},
}
...
SHOP_EDITCART_NG_MODEL_OPTIONS = (
    "{updateOn: 'default blur', debounce: {'default': 2500, 'blur': 0}}"
)
